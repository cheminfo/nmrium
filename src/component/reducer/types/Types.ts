...
export const CHANGE_INTEGRAL = 'CHANGE_INTEGRAL';
...
export const SET_ZONE_DIAID = 'SET_ZONE_DIAID';
...
export const RECOLOR_SPECTRA_COLOR = 'RECOLOR_SPECTRA_COLOR';
export const ORDER_SPECTRA = 'ORDER_SPECTRA';
