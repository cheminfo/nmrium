...
export const TOGGLE_MOLECULE_ATOM_NUMBER = 'TOGGLE_MOLECULE_ATOM_NUMBER';
export const CHANGE_FLOAT_MOLECULE_POSITION = 'CHANGE_FLOAT_MOLECULE_POSITION';
...
export const SHOW_MULTIPLICITY_TREES = 'SHOW_MULTIPLICITY_TREES';
...
export const SHOW_ZONES = 'SHOW_ZONES';
export const SHOW_ZONES_SIGNALS = 'SHOW_ZONES_SIGNALS';
export const SHOW_ZONES_PEAKS = 'SHOW_ZONES_PEAKS';
...
export const TOGGLE_PEAKS_VIEW_PROPERTY = 'TOGGLE_PEAKS_VIEW_PROPERTY';
export const ORDER_MULTIPLE_SPECTRA_ANALYSIS =
  'ORDER_MULTIPLE_SPECTRA_ANALYSIS';
export const APPLY_SIGNAL_PROCESSING_FILTER = 'APPLY_SIGNAL_PROCESSING_FILTER';
export const SET_MATRIX_GENERATION_OPTIONS = 'SET_MATRIX_GENERATION_OPTIONS';
export const ADD_MATRIX_GENERATION_EXCLUSION_ZONE =
  'ADD_MATRIX_GENERATION_EXCLUSION_ZONE';
export const DELETE_MATRIX_GENERATION_EXCLUSION_ZONE =
  'DELETE_MATRIX_GENERATION_EXCLUSION_ZONE';
export const IMPORT_SPECTRA_META_INFO = 'IMPORT_SPECTRA_META_INFO';
export const TOGGLE_SPECTRA_LEGEND = 'TOGGLE_SPECTRA_LEGEND';
