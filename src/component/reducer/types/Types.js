...
export const SET_RANGE_IN_EDITION = 'SET_RANGE_IN_EDITION';
export const UNSET_RANGE_IN_EDITION = 'UNSET_RANGE_IN_EDITION';
export const SET_NEW_SIGNAL_DELTA_SELECTION_IS_ENABLED =
  'SET_NEW_SIGNAL_DELTA_SELECTION_IS_ENABLED';
export const SET_SELECTED_NEW_SIGNAL_DELTA = 'SET_SELECTED_NEW_SIGNAL_DELTA';
export const UNSET_SELECTED_NEW_SIGNAL_DELTA =
  'UNSET_SELECTED_NEW_SIGNAL_DELTA';
export const SET_SHOW_MULTIPLICITY_TREES = 'SET_SHOW_MULTIPLICITY_TREES';
export const SET_ACTIVE_ASSIGNMENT_AXIS = 'SET_ACTIVE_ASSIGNMENT_AXIS';
export const UNSET_ACTIVE_ASSIGNMENT_AXIS = 'UNSET_ACTIVE_ASSIGNMENT_AXIS';
