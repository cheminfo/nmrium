  ...
  databasePreferences,
    ...
    },
    {
      ...
      accessor: (row) => {
        ...
        return row?.from && row?.to ? `${formatNumber(row.from, rangeFormat)} - ${formatNumber(
          row.to,
          rangeFormat,
        )}` : "";
      },
    ...
    },
    {
      ...
      accessor: (row) => {
        ...
        return row?.delta ? formatNumber(row.delta, databasePreferences.delta.format) : '';
      },
    },
...

    {
      ...
      Header: 'J (Hz)',
      accessor: (row) =>
        row?.coupling ? formatNumber(row.coupling, databasePreferences.coupling.format) : "",
      style: {
        width: '60px',
        minWidth: '60px',
        ...overFlowStyle,
